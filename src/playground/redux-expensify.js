...
const expenseOne = store.dispatch(
  addExpense({ description: 'rent', amount: 450, createAt: 1000 })
);
const expenseTwo = store.dispatch(
  addExpense({ description: 'coffre', amount: 3, createAt: -1000 })
);
...
store.dispatch(setEndDate(1205));*/
const demoState = {
  expenses: [
    {
      id: 'rezrez',
      description: 'January Rent',
      note: 'This was the finall payment for that address',
      amount: 460,
      createAt: 0
    }
  ],
